...
class ConduitHelper extends Helper{
    ...
    private function send(){
        ...
        $client = new Client('http://'.$this->url.'/blocks/conduit/webservices/rest/', array('curl.CURLOPT_CONNECTTIMEOUT'=>100, 'curl.CURLOPT_TIMEOUT'=> 60,));
        try{
