...
class ContentHelper extends Helper {
     ...
     */
    protected $word = array('albatross',
                             'army',
                             'ariel',
                             'accident',
                             'alphabet',
     ...
     */
    protected $firstnames = array('bob',
                        'brandi',
                        'betty',
                        'bobbie',
                        'brian',
     ...
     */
    protected $lastnames = array('smith',
                       'gonzales',
                       'jones',
                       'takawa',
                       'johnson',
     ...
     */
    protected $html = array('paragraph'=> 'p',
         'sentence' => 'p',
         'question' => 'p',
         'header'   => 'h2'
        );
     ...
     */
    protected $creole = array('paragraph'=> '\\\\',
         'sentence' => '\\\\',
         'question' => '\\\\',
         'header'   => '='
        );
